...
VOID CSystemData::SetBoolClear(VOID) {
    switch (D_001658B8[0]) {
        case 0:
        this->m_dwClearFlag |= 0x1;
        break;
        case 1:
        this->m_dwClearFlag |= 0x2;
        break;
        case 2:
        this->m_dwClearFlag |= 0x4;
        break;
        case 3:
        this->m_dwClearFlag |= 0x8;
        break;
    }
...
inline VOID CSystemData::SystemDataReset(VOID) {
    ...
    this->unk0 = 0x11;
    this->unk8 = 0x67;
    this->unk8 = (UCHAR)this->unk8 | 0x100;
...
VOID CSaveData::GetColosseumPrize(eSAVE_COLOSSEUM, int) {
}

VOID CSaveData::BoolColosseumEntry(eSAVE_COLOSSEUM) {
}

DWORD CSaveData::GetColosseumVictoryCount(eSAVE_COLOSSEUM eIdx) {
    return m_SaveData.ColosseumFlag.lpdwVictoryCount[eIdx];
}

VOID CSaveData::SetColosseumVictoryCount(eSAVE_COLOSSEUM eIdx, DWORD dwVal) {
    m_SaveData.ColosseumFlag.lpdwVictoryCount[eIdx] = dwVal;
}

DWORD CSaveData::GetColosseumLoseCount(eSAVE_COLOSSEUM eIdx) {
    return m_SaveData.ColosseumFlag.lpdwLoseCount[eIdx];
}

VOID CSaveData::SetColosseumLoseCount(eSAVE_COLOSSEUM eIdx, DWORD dwVal) {
    m_SaveData.ColosseumFlag.lpdwLoseCount[eIdx] = dwVal;
}

DWORD CSaveData::GetColosseumWinCount(eSAVE_COLOSSEUM eIdx) {
    return m_SaveData.ColosseumFlag.lpdwWinCount[eIdx];
}

VOID CSaveData::SetColosseumWinCount(eSAVE_COLOSSEUM eIdx, DWORD dwVal) {
    m_SaveData.ColosseumFlag.lpdwWinCount[eIdx] = dwVal;
}

VOID CSaveData::ResetDefeat() {
}

VOID CSaveData::GetLockerRate() {
}

VOID CSaveData::SaveDataResetPtr(sdData*) {
}

VOID CSaveData::SaveDataHeaderResetPtr(sdData*) {
}
