...
/*  Copyright.: Copyright © 1993-2001 Metrowerks, Inc.					*/
/************************************************************************/
...
typedef struct PTMF {
	...
	int	vtbl_offset;				//	offset in vtable (-1: not a virtual function)
	union {
		void *func_addr;			//	nonvirtual function address
		int	ventry_offset;			//	offset of virtual function entry in vtable
	}	func_data;
}	PTMF;
...
extern void		*__clear(char *mem,size_t size);
...
extern void 	__initialize_cpp_rts(void (**si)(void), void (**esi)(void), void *ets, void *ete);
extern void 	__initialize_cpp_rts_overlay(void (**si)(void), void (**esi)(void), void *ets, void *ete);
